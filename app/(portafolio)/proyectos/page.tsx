...
const FREELANCE: Project[] = [
  ...
  {
    title: 'Proyecto Freelance lb.codeworks',
    description:
      'Genere una marca personal como desarrollador freelance, generando una web de servicios tipo landing page, con diseño neomorfismo, contacto profesional, multi idioma, temas oscuros y claros .',
